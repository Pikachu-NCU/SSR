...
def test(use_A=False, use_B=False, test_set_name="test"):
    ...
    params_path = {
        "0_0": "./params/params-No-Overlap-No-SSR.pth",
        "0_1": "./params/params-No-Overlap-Only-SSR.pth",
        "1_0": "./params/params-No-SSR-Only-Overlap.pth",
        "1_1": "./params/params-Overlap-And-SSR.pth"
    }
